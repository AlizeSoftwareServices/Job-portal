const fs = require('fs');
let c = fs.readFileSync('frontend/src/app/signup/page.tsx', 'utf8');
...
if (!c.includes('<style>{`')) {
  ...
  fs.writeFileSync('frontend/src/app/signup/page.tsx', c);
  console.log('Added loading bar to signup page');
}

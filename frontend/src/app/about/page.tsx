...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-zinc-50 font-sans selection:bg-sky-100">
      <Navbar />

      {/* Hero Section */}
      <section className="relative bg-sky-800 text-white pt-32 pb-24 lg:pt-40 lg:pb-32 overflow-hidden">
        {/* Background Effects */}
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-sky-900/20 blur-[100px] rounded-full pointer-events-none"></div>
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-cyan-900/20 blur-[100px] rounded-full pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
          <div className="flex-1 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sky-900/40 text-sky-300 font-medium text-sm mb-6 border border-sky-800/50">
              <span className="w-2 h-2 rounded-full bg-sky-400 animate-pulse"></span>
              Leading Professional Recruitment
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Bridging the gap between <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-cyan-300">Talent & Opportunity</span>
            </h1>
            <p className="text-lg text-sky-200 mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              At Skyo Consultancy, we specialize in delivering comprehensive manpower solutions, 
              connecting exceptional candidates with the world's top clients through permanent, contract, and temporary placements.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <Link href="/jobs" className="bg-sky-600 hover:bg-sky-500 text-white px-8 py-4 rounded-xl font-bold transition-all shadow-[0_0_20px_rgba(37,99,235,0.3)] flex items-center gap-2 group w-full sm:w-auto justify-center">
                Find Your Next Job
          ...
          <div className="flex-1 w-full relative">
            <div className="absolute inset-0 bg-gradient-to-tr from-sky-600 to-cyan-600 rounded-[2rem] transform rotate-3 scale-105 opacity-50 blur-xl"></div>
            <img 
              src="/about-hero.png" 
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-2xl shadow-xl border border-zinc-100 flex items-center gap-4 animate-bounce" style={{ animationDuration: '3s' }}>
              ...
              <div>
                ...
                <p className="text-zinc-900 font-black">Top Clients</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-sky-800 font-bold tracking-widest uppercase text-sm mb-3">Our Core Expertise</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Service 1 */}
            <div className="bg-zinc-50 rounded-3xl p-8 border border-zinc-100 hover:border-sky-200 hover:shadow-xl hover:shadow-sky-900/5 transition-all group">
              <div className="w-14 h-14 bg-sky-100 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform group-hover:bg-sky-600">
                <Users className="w-7 h-7 text-sky-600 group-hover:text-white transition-colors" />
              </div>
            ...
            {/* Service 2 */}
            <div className="bg-zinc-50 rounded-3xl p-8 border border-zinc-100 hover:border-sky-200 hover:shadow-xl hover:shadow-sky-900/5 transition-all group">
              <div className="w-14 h-14 bg-cyan-100 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform group-hover:bg-cyan-600">
                <Target className="w-7 h-7 text-cyan-600 group-hover:text-white transition-colors" />
              </div>
              <h4 className="text-xl font-bold text-zinc-900 mb-3">Recruitment & Placement</h4>
              <p className="text-zinc-600 text-sm leading-relaxed">
                Precision-driven sourcing and placement services. We meticulously match candidates' skills and aspirations with client requirements.
              </p>
            </div>
      ...
      <section className="py-24 bg-zinc-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-sky-800 rounded-[3rem] p-10 md:p-16 lg:p-20 relative overflow-hidden shadow-2xl">
            {/* Decorative Elements */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-sky-600 rounded-full blur-[80px] opacity-20 transform translate-x-1/2 -translate-y-1/2"></div>
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-cyan-600 rounded-full blur-[80px] opacity-20 transform -translate-x-1/2 translate-y-1/2"></div>
            ...
            <div className="relative z-10 flex flex-col lg:flex-row gap-12 items-center">
              <div className="flex-1 text-center lg:text-left text-white">
                ...
                <Link href="/signup" className="inline-flex items-center gap-2 bg-white text-sky-800 px-8 py-4 rounded-xl font-bold hover:bg-zinc-200 transition-colors">
                  Join Our Network
                </Link>
              </div>
              <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
                <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-6 text-white text-center sm:text-left">
                   ...
                   <p className="text-sm text-sky-200">Rapid deployment of qualified candidates to meet urgent needs.</p>
                </div>
                <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-6 text-white text-center sm:text-left">
                   ...
                   <p className="text-sm text-sky-200">Strict adherence to zero-cost job seeking and anti-child labour laws.</p>
                </div>
                <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-6 text-white text-center sm:text-left sm:col-span-2">
                   <Award className="w-8 h-8 text-sky-400 mb-4 mx-auto sm:mx-0" />
                   <h5 className="font-bold text-lg mb-2">Industry Expertise</h5>
                   <p className="text-sm text-sky-200">Specialized teams for IT, Non-IT, Manufacturing, and Healthcare sectors.</p>
                </div>
              </div>
            </div>
          </div>
